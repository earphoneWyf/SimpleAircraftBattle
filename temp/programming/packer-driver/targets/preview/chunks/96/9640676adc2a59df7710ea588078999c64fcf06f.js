  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        reset() {
          var hero = this.gameArea.getChildByName('hero');
          hero.setPosition(-5, -316);
          var enemy = this.gameArea.getChildByName('enemy');
...
//# sourceMappingURL=9640676adc2a59df7710ea588078999c64fcf06f.js.map